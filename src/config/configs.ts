...
export const NOTIFICATION_API_KEY: string | undefined =
	process.env.NOTIFICATION_API_KEY;
export const NOTIFICATION_ACCESS_TOKEN: string | undefined =
	process.env.X_ACCESS_TOKEN;
export const NOTIFICATION_API_PATH: string | undefined =
	process.env.NOTIFICATION_API_PATH;
export const ERR_CHAT_ID: string | undefined =
	process.env.ERROR_TELEGRAM_CHAT_ID;
